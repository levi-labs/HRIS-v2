...
import { EmployeeScheduleRequest, employeeScheduleSchema } from "../validations/employeeSchedule.validation.js";
...
export class EmployeeScheduleService {
    ...
    static async create(data:EmployeeScheduleRequest):Promise<EmployeeWorkSchedule> {
        ...
        const validated = Validation.validate<EmployeeScheduleRequest>(employeeScheduleSchema,data);
        const scheduleExists = await prisma.employeeWorkSchedule.findFirst({
            where: {
